  ...
  const goals = [
    {
      ...
      description: "Just beginning my piano journey or learning the basics",
    },
    {
      value: "intermediate" as const,
      icon: GraduationCap,
      label: "Building Skills",
      description: "Working on technique, taking lessons, or practicing regularly",
    },
    {
      value: "professional" as const,
      icon: Trophy,
      label: "Serious Performance",
      description: "Preparing for competitions, recitals, or professional work",
    },
    {
      value: "casual" as const,
      icon: Headphones,
      label: "Playing for Joy",
      description: "Enjoying music as a hobby without pressure or deadlines",
    },
  ]

  return (
    <section id="question-4" className="py-20 px-6 bg-card border-t border-border">
